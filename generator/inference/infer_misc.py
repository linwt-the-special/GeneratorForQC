...
# %% ../../src/inference/infer_misc.ipynb 3
from ..imports import *
from ..platform.qcircuit_dataset_construction import decode_circuit, gate_pool_to_gate_classes
from ..platform.simulation.qcircuit_sim import instruction_name_to_gate

# %% ../../src/inference/infer_misc.ipynb 5
